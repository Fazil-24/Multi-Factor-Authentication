...
# proceeding with voice recognition
print("Please proceed with Voice Authentication")
speak("Please proceed with Voice Authentication")
#execute below command for voice authentication
#call(["python","voice_auth.py"])
